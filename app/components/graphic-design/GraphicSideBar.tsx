  ...
  return (
    <div className="flex h-screen w-full bg-white  text-black">
      <Sidebar open={open} setOpen={setOpen} animate={true}>
        ...
        >
          <div className="flex flex-1 flex-col overflow-x-hidden bg-white text-black overflow-y-auto">
            {/* Logo */}
            <div
              className={cn(
                ...
                <SidebarLink
                  ...
                  className={cn(
                    activeLink === link.label
                      ? "bg-neutral-300 text-black bg-white"
                      : "text-black  hover:bg-neutral-200 dark:hover:bg-neutral-800"
                  )}
                />
              ))}
            </div>
